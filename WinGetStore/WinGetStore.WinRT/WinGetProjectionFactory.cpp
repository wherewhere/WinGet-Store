...
namespace winrt::WinGetStore::WinRT::implementation
{
    ...
    const CLSID CLSID_ConfigurationStaticFunctions = { 0x73D763B7, 0x2937, 0x432F, { 0xA9, 0x7A, 0xD9, 0x8A, 0x4A, 0x59, 0x61, 0x26 } };  //73D763B7-2937-432F-A97A-D98A4A596126
    ...
    const CLSID CLSID_PackageManager_Dev = { 0x74CB3139, 0xB7C5, 0x4B9E, { 0x93, 0x88, 0xE6, 0x61, 0x6D, 0xEA, 0x28, 0x8C } };  //74CB3139-B7C5-4B9E-9388-E6616DEA288C
    const CLSID CLSID_FindPackagesOptions_Dev = { 0x1BD8FF3A, 0xEC50, 0x4F69, { 0xAE, 0xEE, 0xDF, 0x4C, 0x9D, 0x3B, 0xAA, 0x96 } };  //1BD8FF3A-EC50-4F69-AEEE-DF4C9D3BAA96
    const CLSID CLSID_CreateCompositePackageCatalogOptions_Dev = { 0xEE160901, 0xB317, 0x4EA7, { 0x9C, 0xC6, 0x53, 0x55, 0xC6, 0xD7, 0xD8, 0xA7 } };  //EE160901-B317-4EA7-9CC6-5355C6D7D8A7
    const CLSID CLSID_InstallOptions_Dev = { 0x44FE0580, 0x62F7, 0x44D4, { 0x9E, 0x91, 0xAA, 0x96, 0x14, 0xAB, 0x3E, 0x86 } };  //44FE0580-62F7-44D4-9E91-AA9614AB3E86
    const CLSID CLSID_UninstallOptions_Dev = { 0xAA2A5C04, 0x1AD9, 0x46C4, { 0xB7, 0x4F, 0x6B, 0x33, 0x4A, 0xD7, 0xEB, 0x8C } };  //AA2A5C04-1AD9-46C4-B74F-6B334AD7EB8C
    const CLSID CLSID_PackageMatchFilter_Dev = { 0x3F85B9F4, 0x487A, 0x4C48, { 0x90, 0x35, 0x29, 0x03, 0xF8, 0xA6, 0xD9, 0xE8 } };  //3F85B9F4-487A-4C48-9035-2903F8A6D9E8
    const CLSID CLSID_ConfigurationStaticFunctions_Dev = { 0xC9ED7917, 0x66AB, 0x4E31, { 0xA9, 0x2A, 0xF6, 0x5F, 0x18, 0xEF, 0x79, 0x33 } };  //C9ED7917-66AB-4E31-A92A-F65F18EF7933
    const CLSID CLSID_DownloadOptions_Dev = { 0x8EF324ED, 0x367C, 0x4880, { 0x83, 0xE5, 0xBB, 0x2A, 0xBD, 0x0B, 0x72, 0xF6 } };  //8EF324ED-367C-4880-83E5-BB2ABD0B72F6
    ...
    {
        void* result = nullptr;
        int32_t hresult = WINRT_IMPL_CoCreateInstance(CLSID_PackageManager_Dev, nullptr, CLSCTX_ALL, guid_of<PackageManager>(), &result);
        return hresult == S_OK && result != nullptr;
    }
    ...
    PackageManager WinGetProjectionFactory::CreatePackageManager()
    {
        if (useDev)
        {
            return winrt::create_instance<PackageManager>(CLSID_PackageManager_Dev, CLSCTX_ALL);
        }
    ...
    FindPackagesOptions WinGetProjectionFactory::CreateFindPackagesOptions()
    {
        if (useDev)
        {
            return winrt::create_instance<FindPackagesOptions>(CLSID_FindPackagesOptions_Dev, CLSCTX_ALL);
        }
    ...
    CreateCompositePackageCatalogOptions WinGetProjectionFactory::CreateCreateCompositePackageCatalogOptions()
    {
        if (useDev)
        {
            return winrt::create_instance<CreateCompositePackageCatalogOptions>(CLSID_CreateCompositePackageCatalogOptions_Dev, CLSCTX_ALL);
        }
    ...
    InstallOptions WinGetProjectionFactory::CreateInstallOptions()
    {
        if (useDev)
        {
            return winrt::create_instance<InstallOptions>(CLSID_InstallOptions_Dev, CLSCTX_ALL);
        }
    ...
    UninstallOptions WinGetProjectionFactory::CreateUninstallOptions()
    {
        if (useDev)
        {
            return winrt::create_instance<UninstallOptions>(CLSID_UninstallOptions_Dev, CLSCTX_ALL);
        }
    ...
    PackageMatchFilter WinGetProjectionFactory::CreatePackageMatchFilter()
    {
        if (useDev)
        {
            return winrt::create_instance<PackageMatchFilter>(CLSID_PackageMatchFilter_Dev, CLSCTX_ALL);
        }
        return winrt::create_instance<PackageMatchFilter>(CLSID_PackageMatchFilter, CLSCTX_ALL);
    }

    DownloadOptions WinGetProjectionFactory::CreateDownloadOptions()
    {
        if (useDev)
        {
            return winrt::create_instance<DownloadOptions>(CLSID_DownloadOptions_Dev, CLSCTX_ALL);
        }
    ...
    PackageManager WinGetProjectionFactory::TryCreatePackageManager()
    {
        if (useDev)
        {
            return winrt::try_create_instance<PackageManager>(CLSID_PackageManager_Dev, CLSCTX_ALL);
        }
    ...
    FindPackagesOptions WinGetProjectionFactory::TryCreateFindPackagesOptions()
    {
        if (useDev)
        {
            return winrt::try_create_instance<FindPackagesOptions>(CLSID_FindPackagesOptions_Dev, CLSCTX_ALL);
        }
    ...
    CreateCompositePackageCatalogOptions WinGetProjectionFactory::TryCreateCreateCompositePackageCatalogOptions()
    {
        if (useDev)
        {
            return winrt::try_create_instance<CreateCompositePackageCatalogOptions>(CLSID_CreateCompositePackageCatalogOptions_Dev, CLSCTX_ALL);
        }
    ...
    InstallOptions WinGetProjectionFactory::TryCreateInstallOptions()
    {
        if (useDev)
        {
            return winrt::try_create_instance<InstallOptions>(CLSID_InstallOptions_Dev, CLSCTX_ALL);
        }
    ...
    UninstallOptions WinGetProjectionFactory::TryCreateUninstallOptions()
    {
        if (useDev)
        {
            return winrt::try_create_instance<UninstallOptions>(CLSID_UninstallOptions_Dev, CLSCTX_ALL);
        }
    ...
    PackageMatchFilter WinGetProjectionFactory::TryCreatePackageMatchFilter()
    {
        if (useDev)
        {
            return winrt::try_create_instance<PackageMatchFilter>(CLSID_PackageMatchFilter_Dev, CLSCTX_ALL);
        }
        return winrt::try_create_instance<PackageMatchFilter>(CLSID_PackageMatchFilter, CLSCTX_ALL);
    }

    DownloadOptions WinGetProjectionFactory::TryCreateDownloadOptions()
    {
        if (useDev)
        {
